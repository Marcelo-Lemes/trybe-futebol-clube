...
- Você deve criar uma branch no seguinte formato: `nome-de-usuario-nome-do-projeto`
  * Exemplo: `git checkout -b maria-sd-027-b-trybe-futebol-clube`
...
- Usando o exemplo anterior: `git push -u origin joaozinho-sd-027-b-trybe-futebol-clube`
...
- `sd-027-b-trybe-futebol-clube/app/backend/package.json`
...
<details>
  ...
  - Vá até a página DO SEU Pull Request, adicione a label de "code-review" e marque seus colegas
    ...
    - No menu à direita, clique no *link* "Reviewers" e digite students, selecione o time tryber/students-sd-027-b
...
[FORMULÁRIO DE AVALIAÇÃO DE PROJETO](https://be-trybe.typeform.com/to/ZTeR4IbH#cohort_hidden=CH27-B&template=betrybe/sd-0x-trybe-futebol-clube)
